    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 推广者列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
import { fetchData,exportData } from "../api/index";
export default {
    name: "basetable",
    data() {
        return {
    ...
    methods: {
        ...
        handleExport() {
            ...
            // let url = window.URL.createObjectURL(new Blob([exceldata]))
            ...
            exportData().then(exceldata=>{
                ...
                link.style.display = 'none'
                link.href =  window.URL.createObjectURL(new Blob([exceldata]))
                document.body.appendChild(link)
                link.click()
